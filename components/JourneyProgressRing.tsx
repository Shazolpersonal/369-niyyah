...
export function JourneyProgressRing({
    ...
    return (
        <View
            ...
            accessibilityLabel={`${t('home.progress.title')}: ${currentDay} / ${totalDays}`}
        >
            ...
            <View style={styles.textContainer}>
                <Text style={[{ fontFamily: f('bold') }, styles.dayText]} importantForAccessibility="no">
                    {currentDay}
                </Text>
                <Text style={[{ fontFamily: f('medium') }, styles.totalText]} importantForAccessibility="no">
                    / {totalDays}
                </Text>
            </View>
        </View>
