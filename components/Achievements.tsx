                    ...
                    >
                        {badge.isUnlocked ? (
                            ...
                            <Pressable
                                ...
                                accessibilityHint="Taps to view celebration animation"
                            >
                                <LinearGradient
                            ...
                            <View
                                ...
                                accessible={true}
                                accessibilityLabel={`Locked. ${t(badge.titleKey)}. ${t(badge.descriptionKey)}`}
                            >
                                <View style={styles.lockedIconWrapper}>
                                    <Text style={styles.lockedIcon} importantForAccessibility="no">
                                        🔒
                                    </Text>
                                </View>
