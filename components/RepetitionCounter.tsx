...
export function RepetitionCounter({
    ...
    return (
        <Animated.View style={[styles.container, animatedStyle, { width: size, height: size }]} accessible={true} accessibilityRole="progressbar" accessibilityValue={{ min: 0, max: total, now: completed }} accessibilityLabel={t("write.progress", { current: String(completed), total: String(total) })}>
