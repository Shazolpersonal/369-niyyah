    ...
    return (
        ...
        >
            ...
            <View style={styles.textContainer}>
                <Text importantForAccessibility="no" style={[styles.numberText, { fontFamily: getFontFamily(language, 'bold') }]}>
                    {completed}
                    <Text importantForAccessibility="no" style={[styles.totalText, { fontFamily: getFontFamily(language, 'regular') }]}>/{total}</Text>
                </Text>
            </View>
        </Animated.View>
    );
