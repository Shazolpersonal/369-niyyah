...
export function RepetitionCounter({
    ...
    const a11yLabel = t('write.progress').replace('{current}', String(completed)).replace('{total}', String(total));
        ...
        >
            ...
            <View style={styles.textContainer}>
                <Text style={[styles.numberText, { fontFamily: getFontFamily(language, 'bold') }]} importantForAccessibility="no" accessibilityElementsHidden={true}>
                    {completed}
                    <Text style={[styles.totalText, { fontFamily: getFontFamily(language, 'regular') }]} importantForAccessibility="no" accessibilityElementsHidden={true}>/{total}</Text>
                </Text>
            </View>
        </Animated.View>
    );
