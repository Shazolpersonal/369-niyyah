...
## 2025-06-01 - Added accessibility attributes to Toast component
...
**Action:** Always include `accessibilityRole="alert"` and `accessibilityLiveRegion="polite"` on custom Toast or notification components.
