...
export function getAchievements(
    ...
    // ⚡ Bolt: Use a single O(N) loop with early exit instead of multiple Object.keys/values calls
    // Impact: Avoids multiple array allocations and redundant iterations
