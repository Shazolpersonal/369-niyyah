...
export default function Dashboard() {
    ...
    // ⚡ Bolt Optimization: Cache the current slot instead of calling isSlotActive multiple times
    // which generates multiple new Date() instances during render
