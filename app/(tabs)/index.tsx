            ...
            >
                ...
                <View style={{ paddingHorizontal: 24 }}>
                    <StaggeredView index={2}>
                        <TaskCard slot="morning" isActive={currentActiveSlot === 'morning'} isCompleted={todayProgress.morning} onPress={() => handleTaskPress('morning')} />
                    </StaggeredView>
                    <StaggeredView index={3}>
                        <TaskCard slot="noon" isActive={currentActiveSlot === 'noon'} isCompleted={todayProgress.noon} onPress={() => handleTaskPress('noon')} />
                    </StaggeredView>
                    <StaggeredView index={4}>
                        <TaskCard slot="night" isActive={currentActiveSlot === 'night'} isCompleted={todayProgress.night} onPress={() => handleTaskPress('night')} />
                    </StaggeredView>
                </View>
            </ScrollView>
