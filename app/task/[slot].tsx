...
export default function TaskInputScreen() {
    ...
    useEffect(() => {
        ...
        borderTransition.value = withTiming(target, {
            duration: 200,
    ...
    const handlePressIn = useCallback(() => {
        buttonScale.value = withSpring(0.95, SPRING_CONFIG);
    }, []);
    ...
    const rBorderStyle = useAnimatedStyle(() => ({
        borderColor: interpolateColor(
            borderTransition.value,
            [0, 1, 2],
            ['#334155', '#10B981', '#F43F5E'],
        ),
    }));
    const rSuccessStyle = useAnimatedStyle(() => ({
    ...
    return (
        <View style={{ flex: 1 }}>
            <LinearGradient
                colors={['#064E3B', '#134E4A', '#1E293B', '#0F172A'] as any}
                ...
                >
                    ...
                    {!allDone && (
                        <Animated.View entering={FadeIn.duration(400)}>
                            <RepetitionCounter
                                total={repetitionTarget}
                                completed={repetitionsCompleted}
                            />
                        </Animated.View>
                    )}
                    ...
                    <ScrollView
                        ...
                        contentContainerStyle={{
                            ...
                            paddingBottom: 24,
                            flexGrow: 1,
                            justifyContent: allDone ? 'center' : 'flex-start',
                        }}
                    ...
                    >
                        ...
                        {allDone && showSuccess && (
                            <Animated.View
                                style={[
                                    rSuccessStyle,
                                    { alignItems: 'center', paddingVertical: 40, zIndex: 20 },
                                ]}
                            >
                                ...
                                <Text style={[s.successTitle, { fontFamily: f('bold') }]}>
                                    {t('task.alhamdulillahComplete')}
                                </Text>
                                <Text style={[s.successSub, { fontFamily: f('medium') }]}>
                                    {t('task.completeDua')}
                                </Text>
                                <Pressable
                                    onPress={() => router.back()}
                        ...
                        {!allDone && showSuccess && (
                            ...
                            >
                                ...
                                <View style={s.flashCard}>
                                    ...
                                    <Text style={[s.flashTitle, { fontFamily: f('bold') }]}>
                                        {t('task.mashaAllah')}
                                    </Text>
                            ...
                            <Animated.View entering={SlideInDown.duration(500).springify()}>
                                ...
                                <View style={s.affirmationCard}>
                                    <LinearGradient
                                        ...
                                        style={s.affirmationAccent}
                                    />
                                    <Text style={[s.affirmationLabel, { fontFamily: f('bold') }]}>
                                        {t('task.todaysNiyyah')}
                                    </Text>
                                    <Text
                                        style={[
                                            { fontSize: 18, lineHeight: 30, marginLeft: 8 },
                                            { fontFamily: f('medium') },
                                        ]}
                                    >
